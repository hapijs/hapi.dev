...
- `restful` - RESTful mode that validates crumb tokens from _"X-CSRF-Token"_ request header for **POST**, **PUT**, **PATCH** and **DELETE** server routes. Disables payload/query crumb validation. Defaults to `false`.
