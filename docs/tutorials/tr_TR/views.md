...
Bir kapsamı nasıl direkt kullanıcı arayüzüne göndereceğimize baktık ancak; ya tüm şablonlarda _her zaman_ elimizin altında olmasını istediğimiz varsayılan bir kapsam varsa?
