...
- [Routes](#routes)
    ...
    - [Handler](#handler)
    - [Parsing](#parsing)
- [Middleware vs Plugins and Extensions](#plugins)
    - [Extension Points](#extension)
    - [Creating a Plugin](#creating)
    - [Loading a Plugin](#load)
        - [Options](#options)
- [body-parser](#bodyParser)
- [cookie-parser](#config)
    - [Setting a Cookie](#settingCookie)
    - [Getting a Cookie Value](#getCookie)
- [Passport -> bell](#bell)
- [express-validator -> joi](#joi)
    - [Input Validation](#input)
    - [Output Validation](#output)
- [app.set('view engine') -> vision](#vision)
    - [Setting the View Engine](#viewengine)
    - [Rendering a View](#view)
- [express.static() -> inert](#inert)
    - [Serving Single Files](#single)
    - [Static File Server](#static)
- [Error handling -> boom](#boom)
